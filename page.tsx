// app/larvae/page.tsx
// specimen-sheet UI: grid of larva profile cards + "ask the hive" box.
// styling: field-guide / lab-specimen aesthetic — pale seafoam sheet, ink-navy type,
// coral accent (it's a lobster), mono labels for wallet addresses.
