...
export default function CardSharksPage() {
  ...
  const armAudio = () => {
    unlockSurveyAudio();
    if (!getSurveyMuted()) startBedMusic();
  };
  ...
  const onCrypto = async (pick?: "higher" | "lower") => {
    if (!match) return;
    armAudio();
      ...
      <div className="mx-auto max-w-3xl">
        ...
        <header className="mb-8 text-center max-md:mb-5">
          ...
          <p className="mx-auto mt-2 max-w-lg text-sm opacity-70">
            Out of 100 larvae — guess, then over/under. Winner climbs a crypto market-cap ladder
            (CoinGecko top 100, names only). Final round is the long run. Your opponent is a larva.
          </p>
        </header>
