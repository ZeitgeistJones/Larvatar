// app/api/larvae/ask/route.ts
// POST { question, count? } → in-character answers from top-N larvae + a consensus line.
// cost guardrails: max 8 larvae per ask, 200-char question cap, 150 asks/day global.
